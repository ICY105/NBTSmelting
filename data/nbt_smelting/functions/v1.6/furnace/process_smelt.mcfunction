...
# Add fuel if needed
execute if block ~ ~ ~ #nbt_smelting:furnaces{BurnTime:0s} if items block ~ ~ ~ container.1 * run function nbt_smelting:v1.6/furnace/fuel
...
execute if score @s nbt_smelting.data >= #total_cook_time nbt_smelting.data run function nbt_smelting:v1.6/furnace/end
