...
execute store result score #output_stacksize nbt_smelting.data run function nbt_smelting:v1.5/furnace/get_stack_size
...
# Start Smelting
execute if score #enable nbt_smelting.data matches 1 if items block ~ ~ ~ container.1 * if block ~ ~ ~ #nbt_smelting:furnaces{BurnTime:0s} run function nbt_smelting:v1.5/furnace/fuel
