...
execute if score #loop nbt_smelting.data matches 1.. unless block ~ ~ ~ #nbt_smelting:smelting_blocks positioned ^ ^ ^0.01 run function nbt_smelting:v1.7/furnace/place
