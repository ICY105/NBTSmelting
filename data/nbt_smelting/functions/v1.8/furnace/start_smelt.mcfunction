...
execute store result score #output_stacksize nbt_smelting.data run function nbt_smelting:v1.8/furnace/get_stack_size
...
# Start Smelting
execute if items block ~ ~ ~ container.1 * if block ~ ~ ~ #nbt_smelting:furnaces{BurnTime:0s} run function nbt_smelting:v1.8/furnace/fuel
