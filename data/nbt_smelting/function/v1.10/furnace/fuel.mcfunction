...
execute unless block ~ ~ ~ #nbt_smelting:furnaces{lit_time_remaining: 0s} if block ~ ~ ~ #nbt_smelting:furnaces[lit=false] run function nbt_smelting:v1.10/furnace/make_lit
